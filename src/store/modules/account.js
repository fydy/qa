...
const state = {
  ...
  auth: {
    ...
    clientID: 'efa5be111f19d468f72e',   // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client ID
    clientSecret: 'a697482e296a363747d1e78ba2b56d3c47fa8b76'  // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client Secret
  },
  gitHubUser: null,  // 这个不要修改，这个不要修改，这个不要修改。
  gitHubUsername: 'fydy',  // 修改成你自己的 GitHub 账号
  copyright: '2014 - 2019',  // 修改成你自己的
  recordNumber: 'null',  // 修改成你自己的备案编号，如果没有备案的话就设置为 null
  repo: 'fydy/issue-blog',  // 记录 Issue 的仓库的全名「用户名/仓库名」
